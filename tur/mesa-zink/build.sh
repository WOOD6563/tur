...
TERMUX_PKG_SRCURL=https://github.com/WOOD6563/mesa-Panfork-android/archive/refs/tags/Idk.tar.gz
TERMUX_PKG_SHA256=b6986d36283a2ab3d991317802e5d4a94fdcc08b340749da003aa2c52587ce4a
TERMUX_PKG_DEPENDS="libandroid-shmem, libc++, libdrm, libexpat, libglvnd, libx11, libxext, libxfixes, libxshmfence, libxxf86vm, ncurses, vulkan-loader, xorg-xrandr, zlib, zstd, spirv-llvm-translator"
